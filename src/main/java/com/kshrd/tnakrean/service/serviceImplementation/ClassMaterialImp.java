...
public class ClassMaterialImp implements ClassMaterialService {
    ...
    @Override
    public boolean insertCourse(ClassMaterialRequest classMaterialRequest, Integer user_id) {
        return classMaterialRepository.insertCourse(classMaterialRequest,user_id);
    }
